class LikesController < ApplicationController
  def index
    ...
    @likes = @q.result(:distinct => true).includes(:users, :photos, :comments).page(params[:page]).per(10)
  ...
  def create
    ...
    @like.photos_id = params[:photos_id]
    @like.comments_id = params[:comments_id]
    @like.friend_id = params[:friend_id]
